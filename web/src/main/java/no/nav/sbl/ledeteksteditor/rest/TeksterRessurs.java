            ...
            put("ledetekster",
                    new ArrayList<HashMap>(){{
                        add(new HashMap<String, Object>(){{
                            ...
                            put("spraak", new ArrayList<HashMap>(){{
                                add(
                                        new HashMap<String, String>(){{
                                            put("lokasjon", "nb");
                                            put("innhold", "Som arbeidssøker kan du få støtte til å dekke utgifter for å komme i arbeid");
                                        }}
                                );
                                add(
                                        new HashMap<String, String>(){{
                                            put("lokasjon", "en");
                                            put("innhold", "[EN] Som arbeidssøker kan du få støtte til å dekke utgifter for å komme i arbeid");
                                        }}
                                );
                            }});
                        }});
                        ...
                        add(new HashMap<String, Object>(){{
                            ...
                            put("spraak", new ArrayList<HashMap>(){{
                                add(
                                        new HashMap<String, String>(){{
                                            put("lokasjon", "nb");
                                            put("innhold", "https://www.nav.no/no/Person/Skjemaer-for-privatpersoner/Skjemaer/Tilleggsstonader/Tilleggsstonader/Innsendingsvalg-tilleggsstonader");
                                        }}
                                );
                                add(
                                        new HashMap<String, String>(){{
